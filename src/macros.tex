%%% NOTES %%%
%
% From these definitions a macros.txt file is generated automatically for mdbook-katex, with the following restrictions:
% - only single-line \newcommand definitions are supported
...
\newcommand{\addsintersection}{\ensuremath{\mathrel{\raisebox{.1em}{\reflectbox{\rotatebox[origin=c]{180}{\addsunion}}}}}}
...
\newcommand{\hetdifftext}[1]{\colorbox{LightBlue}{#1}}
